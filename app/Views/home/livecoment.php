...
<body id="page-top">
    ...
    <section class="page-section" id="">
        <div class="container-fluid" style="padding-right: 35%;">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data.data, function(key, value) {
                        ...
                        html += `<div class="card" >
                            <div class="card-body">
                                <h5 class="card-title">By ` + value.comment_seeder_name + ` on <i>` + value.created_at + `</i></h5>
                                <p class="card-text">` + value.comment + `</p>
                                <button type="button" onclick="test(this)" class="btn btn-default reply" id="` + value.comment_id + `">Reply</button>
                            </div>
                            </div>`;
                        ...
                        if (value.Child.length > 0) {
                            $.each(value.Child, function(key, value2) {
                                html += `<div class="card" >
                            <div class="card-body">
                                <h5 class="card-title">By ` + value2.comment_seeder_name + ` on <i>` + value2.created_at + `</i></h5>
                                <p class="card-text">` + value2.comment + `</p>
